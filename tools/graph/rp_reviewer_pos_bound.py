...
data = get_nums("../../results/bench/samples_rp_reviewer_pos_bound_sqrt.txt")
...
ax.set_xlabel("Reviewer Positions Bound")
ax.set_ylabel("Execution Time (seconds)")

mkdir_p("../../results/graph/")
plt.savefig("../../results/graph/rp_reviewer_pos_bound.pdf",bbox_inches='tight', pad_inches = 0, dpi=200)
