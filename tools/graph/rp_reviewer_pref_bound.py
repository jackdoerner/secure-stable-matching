...
data = get_nums("../../results/bench/summary_rp_reviewer_pref_bound_sqrt.txt")
...
ax.set_xlabel("Reviewer Preference Bound")
ax.set_ylabel("Execution Time (seconds)")

mkdir_p("../../results/graph/")
plt.savefig("../../results/graph/rp_reviewer_pref_bound.pdf",bbox_inches='tight', pad_inches = 0, dpi=200)
