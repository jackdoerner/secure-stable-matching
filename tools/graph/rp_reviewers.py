...
data = get_nums("../../results/bench/samples_rp_reviewers_sqrt.txt")
...
plt.savefig("../../results/graph/rp_reviewers.pdf",bbox_inches='tight', pad_inches = 0, dpi=200)
