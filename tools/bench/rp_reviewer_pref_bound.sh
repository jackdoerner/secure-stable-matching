...
ORAM_TYPE="sqrt"
BENCH_PROG="bench_rp"
BENCH_PROG_ARGS="-n 512 -m 64 -q 4 -s 16 "
BENCH_PROG_VARIABLE_ARG="-r"
BENCH_PROG_VARIABLE_VALS=(16 32 64 128 256)
...
SUMMARY_FILE="summary_rp_reviewer_pref_bound_$ORAM_TYPE.txt"
SAMPLES_FILE="samples_rp_reviewer_pref_bound_$ORAM_TYPE.txt"
