...
ORAM_TYPE="sqrt"
BENCH_PROG="bench_rp"
BENCH_PROG_ARGS="-n 512 -q 4 -r 64 -s 16 "
BENCH_PROG_VARIABLE_ARG="-m"
BENCH_PROG_VARIABLE_VALS=(64 128 256 512 1024)
...
SUMMARY_FILE="summary_rp_reviewers_$ORAM_TYPE.txt"
SAMPLES_FILE="samples_rp_reviewers_$ORAM_TYPE.txt"
