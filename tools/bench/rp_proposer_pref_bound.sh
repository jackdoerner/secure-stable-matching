...
ORAM_TYPE="sqrt"
BENCH_PROG="bench_rp"
BENCH_PROG_ARGS="-n 512 -m 64 -r 64 -s 16 "
BENCH_PROG_VARIABLE_ARG="-q"
...
SUMMARY_FILE="summary_rp_proposer_pref_bound_$ORAM_TYPE.txt"
SAMPLES_FILE="samples_rp_proposer_pref_bound_$ORAM_TYPE.txt"
