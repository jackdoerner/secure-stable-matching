...
ORAM_TYPE="sqrt"
BENCH_PROG="bench_rp"
BENCH_PROG_ARGS="-m 64 -q 4 -r 64 -s 16 "
BENCH_PROG_VARIABLE_ARG="-n"
BENCH_PROG_VARIABLE_VALS=(512 1024 2048 4096 8192)
...
SUMMARY_FILE="summary_rp_proposers_$ORAM_TYPE.txt"
SAMPLES_FILE="samples_rp_proposers_$ORAM_TYPE.txt"
